...
public class RobotCfg {
    ...
    public static class Presets {
        public static Preset Specimen_Intake = new Preset(410,0,0.6);
        public static Preset Enter_Sub = new Preset(4390,0,0.5); // preset for intaking a sample (currently certain death)
        public static Preset Basket_Low = new Preset(0,0,0); // preset for scoring in the low basket
        public static Preset Basket_High = new Preset(1650,0,0.5); // preset for scoring in the high basket
        public static Preset Specemin_Low = new Preset(0,0,0); // preset for scoring a specemin on the low bar
        public static Preset Specemin_High = new Preset(1450,0,0.4); // preset for scoring a specemin on the high bar
        public static Preset Sub_Back = new Preset(2500,0,0.4); // preset for entering the sub backwards
//This last one is will ^^
